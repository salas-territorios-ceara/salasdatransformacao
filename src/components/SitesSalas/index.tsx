      ...
      <div className="flex flex-col justify-center">
        ...
        <div className='mt-16'>
          ...
          <div className='flex flex-col lg:flex-row-reverse mt-6 gap-4'>
            <div className='w-[100%] md:w-[40%] flex flex-col justify-center items-center md:items-start text-center md:text-left'>
              <p className="text-lg">
              ...
              <a className='bg-green-600 px-20 py-2 rounded-lg text-white font-bold mt-2' href="https://saladoempreendedoracopiara.vercel.app/">Acessa Site</a>
            </div>
